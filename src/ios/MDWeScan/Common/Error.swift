...
/// Errors related to the `MDWImageScannerController`
public enum MDWImageScannerControllerError: Error {
...
extension MDWImageScannerControllerError: LocalizedError {
